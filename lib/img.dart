...
class imgfonts extends StatefulWidget {
  const imgfonts({Key? key}) : super(key: key);

  @override
  State<imgfonts> createState() => _imgfontsState();
}

class _imgfontsState extends State<imgfonts> {
  @override
        ...
        body: Stack(
          children: [
            Container(
              ...
              child: Image.asset("assets/images/fontimg2.jpg",fit: BoxFit.cover,),
            ),
            Padding(
